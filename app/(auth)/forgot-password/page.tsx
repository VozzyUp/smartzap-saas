 ...
 *
 * Solicita link de redefinição de senha — Supabase Auth.
 */
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[var(--ds-text-secondary)] mt-1">Recuperar senha</p>
      </div>
      ...
      <div className="bg-[var(--ds-bg-elevated)] border border-[var(--ds-border-default)] rounded-2xl p-6 shadow-xl">
        {sent ? (
          <div className="text-center py-4">
            ...
            <p className="text-[var(--ds-text-primary)] font-medium">Verifique seu email</p>
